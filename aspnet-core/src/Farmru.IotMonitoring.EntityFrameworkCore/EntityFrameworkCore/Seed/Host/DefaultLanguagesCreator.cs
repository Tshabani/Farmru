...
namespace Farmru.IotMonitoring.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = IotMonitoringConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(IotMonitoringDbContext context)
        {
            _context = context;
        }
