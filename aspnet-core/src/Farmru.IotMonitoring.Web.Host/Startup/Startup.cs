...
using Farmru.IotMonitoring.Identity;
...
namespace Farmru.IotMonitoring.Web.Host.Startup
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHostedService<Farmru.IotMonitoring.Web.Host.Nutrients.NutrientBalanceEvaluationHostedService>();
            ...
            services.AddAbpWithoutCreatingServiceProvider<IotMonitoringWebHostModule>(
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwaggerUI(options =>
            {
                ...
                options.SwaggerEndpoint($"/swagger/{_apiVersion}/swagger.json", $"IotMonitoring API {_apiVersion}");
                options.IndexStream = () => Assembly.GetExecutingAssembly()
                    .GetManifestResourceStream("Farmru.IotMonitoring.Web.Host.wwwroot.swagger.ui.index.html");
        ...
        private void ConfigureSwagger(IServiceCollection services)
        {
            services.AddSwaggerGen(options =>
            {
                ...
                {
                    Version = _apiVersion,
                    Title = "IotMonitoring API",
                    Description = "IotMonitoring",
                ...
                if (canShowSummaries)
                {
                    ...
                    var applicationXml = $"Farmru.IotMonitoring.Application.xml";
                    var applicationXmlPath = Path.Combine(AppContext.BaseDirectory, applicationXml);
                    options.IncludeXmlComments(applicationXmlPath);

                    var webCoreXmlFile = $"Farmru.IotMonitoring.Web.Core.xml";
