...
{
    public abstract class IotMonitoringWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static IotMonitoringWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(IotMonitoringWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<IotMonitoringDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<IotMonitoringDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<IotMonitoringDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<IotMonitoringDbContext, Task<T>> func)
        {
            T result;
